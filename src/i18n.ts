  ...
  nl: {
    translation: {
      ...
      hint: {
        ...
        wallChain: "klik om te plaatsen · typ een lengte in mm · Enter sluit de ring · Esc stopt",
  ...
  en: {
    translation: {
      ...
      hint: {
        ...
        wallChain: "click to place · type a length in mm · Enter closes the ring · Esc to end",
