  ...
  nl: {
    translation: {
      ...
      panel: {
        ...
        roomName: "Naam",
        roomNameSel: "Ruimtenaam",
        newRoomName: "Ruimte benoemen",
        roomNamePreset: "Kies",
        roomNameCustom: "eigen naam",
        roomNameNote: "de naam hoort bij het punt; de ruimte eromheen volgt uit de muren",
        zoom: "Zoomen",
        ...
        zoomNote: "sleep een kader om in te zoomen \u00b7 klik een ruimte om die vol in beeld te brengen",
        newVide: "Nieuwe vide",
      ...
      hint: {
        ...
        roomName: "klik in een ruimte om \u201c{{label}}\u201d te schrijven",
        roomNameEmpty: "kies of typ eerst een naam",
        zoom: "sleep een kader \u00b7 klik een ruimte \u00b7 F alles in beeld, Shift+F de selectie",
        ...
        touchSelect: "tik om te selecteren \u00b7 sleep punten, muren en symbolen \u00b7 sleep de \u25c6 greep om te buigen",
        ...
        touchWallChain: "tik om te plaatsen \u00b7 of typ een lengte in mm \u00b7 Klaar sluit de keten",
        ...
        touchRoomName: "tik in een ruimte om “{{label}}” te schrijven",
        touchRoomNameEmpty: "kies of typ eerst een naam",
        touchZoom: "sleep een kader · tik een ruimte · dubbeltik het doek voor alles in beeld",
      },
      status: {
  ...
  en: {
    translation: {
      ...
      panel: {
        ...
        roomName: "Name",
        roomNameSel: "Room name",
        newRoomName: "Name a room",
        roomNamePreset: "Pick",
        roomNameCustom: "own name",
        roomNameNote: "the name belongs to the point; the room around it follows from the walls",
        zoom: "Zoom",
        zoomAll: "Fit all",
        ...
        zoomZones: "Rooms",
        zoomUnnamed: "unnamed",
        zoomNote: "drag a box to zoom into it \u00b7 click a room to frame it",
        newVide: "New vide",
        videWidth: "Width (mm)",
        videDepth: "Depth (mm)",
        videLabel: "Caption",
      ...
      hint: {
        ...
        roomName: "click in a room to write \u201c{{label}}\u201d",
        roomNameEmpty: "pick or type a name first",
        zoom: "drag a box \u00b7 click a room \u00b7 F fits all, Shift+F the selection",
        ...
        touchSelect: "tap to select \u00b7 drag points, walls and symbols \u00b7 drag the \u25c6 grip to bow",
        touchSelectWall: "tap the mm value to edit \u00b7 drag the \u25c6 grip to bow",
        touchWallStart: "tap to start a wall chain",
        touchWallChain: "tap to place \u00b7 or type a length in mm \u00b7 Done ends the chain",
        ...
        touchRoomName: "tap inside a room to write “{{label}}”",
        touchRoomNameEmpty: "pick or type a name first",
        touchZoom: "drag a box · tap a room · double-tap the paper to fit all",
      },
      status: {
