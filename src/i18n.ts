  ...
  nl: {
    translation: {
      ...
      panel: {
        ...
        permitExport: "Blad exporteren (SVG)",
      ...
      hint: {
        ...
        select: "klik om te selecteren · sleep punten/muren/symbolen, Alt+slepen kopieert · klik de oppervlakte om de ruimte te benoemen · Del verwijdert",
        ...
        touchSelect: "tik om te selecteren \u00b7 sleep punten, muren en symbolen \u00b7 tik de oppervlakte om de ruimte te benoemen",
      ...
      status: {
        ...
        permitSaved: "floorplan-sheet.svg opgeslagen",
  ...
  en: {
    translation: {
      ...
      hint: {
        ...
        select: "click to select · drag nodes/walls/symbols, Alt-drag copies · click a room's area figure to name it · Del deletes",
        ...
        touchSelect: "tap to select \u00b7 drag points, walls and symbols \u00b7 tap a room's area figure to name it",
      ...
      status: {
        ...
        permitSaved: "floorplan-sheet.svg saved",
