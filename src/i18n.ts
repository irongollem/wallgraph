  ...
  nl: {
    translation: {
      ...
      hint: {
        ...
        select: "klik om te selecteren · sleep punten/muren/symbolen · klik de oppervlakte om de ruimte te benoemen · Del verwijdert",
  ...
  en: {
    translation: {
      ...
      hint: {
        ...
        select: "click to select · drag nodes/walls/symbols · click a room's area figure to name it · Del deletes",
