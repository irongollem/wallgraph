  ...
  nl: {
    translation: {
      ...
      panel: {
        ...
        wallSurfaceNote: "vlaklengte × hoogte van de muur, beide zijden, sparingen op ware grootte afgetrokken · de hoogte is vloer tot vloer, niet tot een verlaagd plafond · dagkanten tellen niet mee",
  ...
  en: {
    translation: {
      ...
      panel: {
        ...
        wallSurfaceNote: "face length × wall height, both faces, openings deducted at their stated size · the height is floor to floor, not up to a suspended ceiling · reveals are not counted",
