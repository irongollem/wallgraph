  ...
  nl: {
    translation: {
      ...
      tool: {
        ...
        stair: "Trap plaatsen",
        vide: "Vide plaatsen",
        cabinet: "Kast plaatsen",
        route: "Leiding tekenen",
        zoom: "Zoomen",
      ...
      panel: {
        ...
        cabinet: "Kast: {{kind}}",
        cabinetCustom: "op maat",
        newCabinet: "Nieuwe kast",
        cabinetPreset: "Type",
        cabinetKind: "Hoogteklasse",
        cabinetWidth: "Breedte (mm)",
        cabinetDepth: "Diepte (mm)",
        cabinetHeight: "Hoogte (mm)",
        cabinetFront: "Front",
        ...
        cabinetLabel: "Opschrift",
        cabinetFootprint: "Maat",
        ...
        showRoutesElectrical: "Elektra tonen",
        showRoutesWater: "Water tonen",
        showRoutesVent: "Ventilatie tonen",
        showRoutesGas: "Gas tonen",
        ...
        cabinetGroup: "{{n}} kasten geselecteerd · verplaatsen, draaien, spiegelen en verwijderen gelden voor alle",
      ...
      hint: {
        ...
        selectCabinet: "Shift+klik kiest meer kasten · slepen verplaatst alles wat geselecteerd is, Alt+slepen kopieert · R draait, M spiegelt",
        selectMode: "{{n}} geselecteerd · tik voegt toe of haalt weg · Klaar sluit af, X wist de selectie",
        ...
        cabinet: "klik om {{label}} te plaatsen (R kwartslag, M spiegelt de draairichting)",
        ...
        touchSelectCabinet: "sleep de kast om die te verplaatsen \u00b7 tik ernaast om de selectie los te laten",
        touchSelectMode: "{{n}} geselecteerd \u00b7 tik voegt toe of haalt weg \u00b7 Klaar sluit af",
        ...
        touchCabinet: "tik om {{label}} te plaatsen",
  ...
  en: {
    translation: {
      ...
      panel: {
        ...
        cabinet: "Cabinet: {{kind}}",
        cabinetCustom: "custom",
        newCabinet: "New cabinet",
        cabinetPreset: "Type",
        cabinetKind: "Height class",
        cabinetWidth: "Width (mm)",
        cabinetDepth: "Depth (mm)",
        cabinetHeight: "Height (mm)",
        cabinetFront: "Front",
        ...
        cabinetLabel: "Annotation",
        cabinetFootprint: "Size",
        ...
        routeMaterialsWater: "{{water}} \u00d8{{diameter}} mm",
        routeMaterialsGas: "Gas \u00d8{{diameter}} mm",
        showRoutesElectrical: "Show electrical",
        showRoutesWater: "Show water",
        showRoutesVent: "Show ventilation",
        showRoutesGas: "Show gas",
        newStair: "New stair",
        stairKind: "Type",
        stairWidth: "Width (mm)",
        stairGoing: "Going (mm)",
        ...
        cabinetGroup: "{{n}} cabinets selected · moving, turning, mirroring and deleting apply to all",
        selectionHeader: "{{n}} × {{label}}",
      ...
      hint: {
        ...
        selectCabinet: "Shift-click selects more cabinets · dragging moves everything selected, Alt-drag copies · R turns, M mirrors",
        selectMode: "{{n}} selected · tap adds or removes · Done finishes, X clears the selection",
        ...
        cabinet: "click to place {{label}} (R turns a quarter, M flips the hinge side)",
        ...
        touchSelectCabinet: "drag the unit to move it \u00b7 tap beside it to let the selection go",
        touchSelectMode: "{{n}} selected \u00b7 tap adds or removes \u00b7 Done finishes",
        ...
        touchCabinet: "tap to place {{label}}",
