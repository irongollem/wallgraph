  ...
  nl: {
    translation: {
      ...
      tool: {
        ...
        stair: "Trap plaatsen",
        structure: "Constructie: kolom, balk, leuning, vide, balklaag",
        furnishing: "Inrichten",
        route: "Installaties",
        zoom: "Zoomen",
        measure: "Meetlint: afstand tussen twee punten",
      ...
      panel: {
        ...
        structurePlain: "Constructie",
        structureColumn: "Kolom",
        structureBeam: "Balk",
        structureRailing: "Leuning",
        structureVide: "Vide",
        structureDeck: "Balklaag",
        deckWidth: "Breedte (mm)",
        deckDepth: "Diepte (mm)",
        deckAxis: "Balkrichting",
        deckAxis_x: "over de breedte",
        deckAxis_y: "over de diepte",
        deckJoistMm: "Balken h.o.h. (mm)",
        deckSectionOn: "Balkdoorsnede",
        deckJoistW: "Balkbreedte (mm)",
        deckJoistD: "Balkhoogte (mm)",
        deckBearing: "Oplegging per eind (mm)",
        deckDecking: "Vloerplaat (mm)",
        ...
        deckLoadG: "Permanente belasting (N/m²)",
        deckLoadQ: "Veranderlijke belasting (N/m²)",
        deckLoadNote: "indicatieve waarden · gemeld, niet getoetst",
        deckLabel: "Opschrift",
        ...
        columnShape_round: "rond",
        columnShape_h: "H-profiel",
        columnWidth: "Breedte (mm)",
        columnDepth: "Diepte (mm)",
        ...
        boardGroup: "Groep {{n}}",
        boardGroupLabel: "Voedt",
        boardGroupRuns: "Aangesloten",
        boardGroupRunCount: "{{n}} leidingen",
        ...
        routeHeatAanvoer: "CV aanvoer",
        routeHeatRetour: "CV retour",
        ...
        material_glass: "glas",
        material_sandwich: "sandwichpaneel",
        material_aerated: "cellenbeton",
        material_calciumsilicate: "kalkzandsteen",
        postsOn: "Stijlen",
        posts: "Stijlafstand h.o.h. (mm)",
        postLayout: "Stijlverdeling",
        ...
        liningOn: "Beplating",
        liningBoard: "Plaatdikte (mm)",
        liningLayers: "Aantal lagen",
        liningHelp: "beplating buiten de muurdikte \u00b7 het netto oppervlak wordt gemeten tot de afgewerkte kant, niet tot de constructie",
        blockOn: "Blokformaat opgeven",
        blockLength: "Bloklengte (mm)",
        blockHeight: "Blokhoogte (mm)",
        noggingRows: "Klossen (rijen)",
        ...
        lintelBearing: "Oplegging latei per eind (mm)",
        lintelBearingHelp: "zonder eigen opgave geldt {{mm}} mm",
        lintelSectionOn: "Latei doorsnede",
        lintelWidth: "Lateibreedte (mm)",
        lintelDepth: "Lateihoogte (mm)",
        lintelLoadOn: "Extra belasting op latei",
        lintelLoad: "Extra belasting (kN/m)",
        lintelLoadHelp: "bijvoorbeeld een balklaag die op deze muur oplegt",
        ...
        storey: "Verdieping",
        floors: "Verdiepingen",
        floorManage: "Verdiepingen beheren",
        ...
        wallSurfaceLiningNote: "gemeten tot het constructieve vlak · opgegeven beplating ligt hier buiten",
        ...
        roomWallSurfaceCeiling: "plafond op {{mm}} mm",
        keypadPlace: "Plaats",
        keypadClear: "Wissen",
        ...
        // two inspectors.
        energyOwnRc: "Eigen Rc-waarde",
        rc: "Rc (m²K/W)",
        rcPlan: "Rc {{rc}} m²K/W (plan)",
        energyOwnU: "Eigen U-waarde",
        uValue: "U (W/m²K)",
        uValuePlan: "U {{u}} W/m²K (plan)",
      },
      profile: {
        sloped: "Hellend",
        help: "Rechtlijnig tussen de punten; een uiteinde zonder eigen punt staat op de muurhoogte.",
        endHeight: "Eindhoogte (mm)",
        pointHeight: "Hoogte punt (mm)",
        pointRemove: "Punt {{n}} verwijderen",
      ...
      energy: {
        title: "Energie",
        notStated: "niet opgegeven",
        custom: "aangepast",
        insulation: "Isolatie",
        insulation_none: "ongeïsoleerd (voor 1975)",
        insulation_light: "licht (1975–1991)",
        insulation_bb1992: "Bouwbesluit 1992",
        insulation_bb2013: "Bouwbesluit 2013",
        insulation_bb2015: "Bouwbesluit 2015",
        insulation_beng: "BENG 2021",
        glazing: "Beglazing",
        glazing_single: "enkel glas",
        glazing_double: "dubbel glas",
        glazing_hrpp: "HR++",
        glazing_triple: "triple glas",
        rcWall: "Rc gevel",
        rcRoof: "Rc dak",
        rcFloor: "Rc vloer",
        uWindow: "U raam",
        uDoor: "U deur",
        envelopeArea: "Verliesoppervlak Als",
        envelopeWalls: "dichte gevel",
        envelopeGlazing: "glas",
        envelopeDoors: "deuren",
        envelopeRoof: "dak",
        envelopeGround: "begane grondvloer",
        usableArea: "Gebruiksoppervlak Ag",
        ...
        closingNote: "Gemeten aan de gevelzijde van de constructie, per verdieping van vloer tot vloer; het dak als het bovenste vloerveld. Gemeld, niet getoetst.",
      },
      roof: {
        title: "Dak",
        ...
        plane: "Vlak {{n}}",
        eave: "Dakrandhoogte (mm)",
        pitch: "Hellingshoek (°)",
        ownThickness: "Eigen dakdikte",
        thickness: "Dakdikte (mm)",
        thicknessNote: "zonder eigen opgave geldt {{mm}} mm",
        area: "Hellend oppervlak",
        ...
        headroomLow: "{{room}} — lager dan 1500 mm",
        headroomUsable: "{{room}} — gebruiksoppervlak",
        headroomNote: "NEN 2580 telt vloeroppervlak onder 1500 mm niet mee in het gebruiksoppervlak.",
      ...
      materials: {
        ...
        kerf: "Zaagsnede (mm)",
        waste: "Afschrijving (%)",
        sheetWidth: "Plaatbreedte (mm)",
        sheetHeight: "Plaathoogte (mm)",
        noWalls: "Geen muren of balklagen op deze verdieping.",
        nothing: "Niets te melden: geen enkele muur op deze verdieping draagt regelwerk, blokformaat, beplating, isolatie of paneelbreedte.",
        system: {
          framedTimber: "Houten regelwerk",
          framedSteel: "Stalen regelwerk",
          block: "Blokopbouw",
          sandwich: "Sandwichwand",
          other: "Overig",
        },
        member: {
          stud: "Stijl",
        ...
        timberClass_GL24h: "GL24h — lijmhout",
        kmod: "k_mod (belastingduur, klimaatklasse)",
        gammaM: "γ_M (materiaalfactor)",
        kdef: "k_def (kruip)",
        ...
        csv: {
          ...
          stockItem: "Voorraadlengte",
          wasteItem: "Afschrijving",
          splicesItem: "Lasverbindingen",
        },
      },
      checks: {
        title: "Constructie",
        loadG: "Belasting permanent (kN/m)",
        loadQ: "Belasting variabel (kN/m)",
        loadWall: "Eigen gewicht muur (kN/m)",
        loadExtra: "Extra belasting (kN/m)",
        span: "Overspanning",
        section: "Doorsnede",
        bending: "Buiging",
        shear: "Afschuiving",
        deflection: "Doorbuiging",
        deflectionValue: "Doorbuiging / grens",
        result: "Resultaat",
        pass: "voldoet",
        fail: "voldoet niet",
        governing: "maatgevend",
        missingRow: "Ontbreekt: {{row}}",
        missingWallMaterial: "materiaal van de muur (in het muurpaneel)",
      ...
      frame: {
        ...
        note_postWidth: "Profielbreedte niet opgegeven — stijlen niet getekend",
        note_block: "Blokformaat niet opgegeven — lagen niet getekend",
        note_panel: "Paneelbreedte niet opgegeven — panelen niet getekend",
        breaks: "Framebreuken",
        breakHeight: "Hoogte breuk {{n}} (mm)",
      ...
      symbol: {
        ...
        "heat-pump-ground": "Bodemwarmtepomp",
        "heat-pump-outdoor": "Warmtepomp buitenunit",
        "airco-wall": "Split-unit wand (airco / lucht-lucht)",
        "airco-ceiling": "Plafondcassette (airco / lucht-lucht)",
  ...
  en: {
    translation: {
      ...
      tool: {
        ...
        stair: "Place stair",
        structure: "Structure: column, beam, railing, void, deck",
        furnishing: "Fit-out",
        route: "Services",
        zoom: "Zoom",
        measure: "Tape measure: distance between two points",
        ...
        shortStair: "Stair",
        shortStructure: "Structure",
        shortFurnishing: "Fit-out",
        shortRoute: "Services",
        shortZoom: "Zoom",
        shortMeasure: "Measure",
        shortGridSnap: "Grid",
      ...
      panel: {
        ...
        deckWidth: "Width (mm)",
        deckDepth: "Depth (mm)",
        deckAxis: "Joist direction",
        deckAxis_x: "across the width",
        deckAxis_y: "across the depth",
        deckJoistMm: "Joist centres (mm)",
        deckSectionOn: "Joist section",
        deckJoistW: "Joist width (mm)",
        deckJoistD: "Joist depth (mm)",
        deckBearing: "Bearing per end (mm)",
        deckDecking: "Decking (mm)",
        ...
        deckLoadG: "Permanent load (N/m²)",
        deckLoadQ: "Variable load (N/m²)",
        deckLoadNote: "indicative figures · reported, not checked",
        deckLabel: "Caption",
        deckArea: "Area",
        deckSpan: "Span",
        deckJoists: "Joists",
        ...
        columnShape_round: "round",
        columnShape_h: "H-section",
        columnWidth: "Width (mm)",
        columnDepth: "Depth (mm)",
        columnDiameter: "Diameter (mm)",
        ...
        boardGroup: "Group {{n}}",
        boardGroupLabel: "Feeds",
        boardGroupRuns: "Connected",
        boardGroupRunCount: "{{n}} runs",
        ...
        routeHeatAanvoer: "CV flow",
        routeHeatRetour: "CV return",
        routeDiameter: "Diameter (mm)",
        ...
        material_sandwich: "sandwich panel",
        material_aerated: "aerated concrete",
        material_calciumsilicate: "calcium silicate",
        postsOn: "Posts",
        posts: "Post centres (mm)",
        postLayout: "Stud layout",
        ...
        liningOn: "Board lining",
        liningBoard: "Board thickness (mm)",
        liningLayers: "Layers",
        liningHelp: "lining outside the wall's thickness \u00b7 the net area is measured to the finished face, not the structure",
        blockOn: "State block format",
        blockLength: "Block length (mm)",
        blockHeight: "Block height (mm)",
        noggingRows: "Noggings (rows)",
        insulated: "Insulated",
        ...
        lintelBearingHelp: "without a stated figure, {{mm}} mm applies",
        lintelSectionOn: "Lintel section",
        lintelWidth: "Lintel width (mm)",
        lintelDepth: "Lintel depth (mm)",
        lintelLoadOn: "Additional load on lintel",
        lintelLoad: "Additional load (kN/m)",
        lintelLoadHelp: "for example a deck bearing on this wall",
        ...
        wallSurfaceLiningNote: "measured to the structural face · a stated lining lies outside it",
        ...
        roomWallSurfaceCeiling: "ceiling at {{mm}} mm",
        keypadPlace: "Place",
        keypadClear: "Clear",
        ...
        // two inspectors.
        energyOwnRc: "Own Rc value",
        rc: "Rc (m²K/W)",
        rcPlan: "Rc {{rc}} m²K/W (plan default)",
        energyOwnU: "Own U value",
        uValue: "U (W/m²K)",
        uValuePlan: "U {{u}} W/m²K (plan default)",
      },
      profile: {
        sloped: "Sloped",
        help: "Straight between the points; an end without a point of its own stands at the wall height.",
        endHeight: "End height (mm)",
        pointHeight: "Point height (mm)",
        pointRemove: "Remove point {{n}}",
        addPoint: "Add point",
        gable: "Gable",
        leanTo: "Lean-to",
      ...
      energy: {
        ...
        insulation_none: "uninsulated (before 1975)",
        insulation_light: "light (1975–1991)",
        insulation_bb1992: "Building Decree 1992",
        insulation_bb2013: "Building Decree 2013",
        insulation_bb2015: "Building Decree 2015",
        insulation_beng: "BENG 2021",
        glazing: "Glazing",
        glazing_single: "single glazing",
        glazing_double: "double glazing",
        glazing_hrpp: "HR++",
        glazing_triple: "triple glazing",
        rcWall: "Rc facade",
        rcRoof: "Rc roof",
        rcFloor: "Rc floor",
        uWindow: "U window",
        uDoor: "U door",
        envelopeArea: "Loss area Als",
        envelopeWalls: "opaque facade",
        envelopeGlazing: "glazing",
        envelopeDoors: "doors",
        envelopeRoof: "roof",
        envelopeGround: "ground floor",
        usableArea: "Usable area Ag",
        ...
        closingNote: "Measured at the structural facade face, storey by storey floor to floor; the roof as the top plate. Reported, never checked.",
      },
      roof: {
        title: "Roof",
        ...
        eave: "Eave height (mm)",
        pitch: "Pitch (°)",
        ownThickness: "Own roof thickness",
        thickness: "Roof thickness (mm)",
        thicknessNote: "without a stated value, {{mm}} mm applies",
        area: "Sloped area",
        ...
        headroomLow: "{{room}} — below 1500 mm",
        headroomUsable: "{{room}} — usable area",
        headroomNote: "NEN 2580 excludes floor area under 1500 mm from the usable floor area.",
      ...
      materials: {
        ...
        nothing: "Nothing to report: no wall on this storey states a frame, a block format, board lining, insulation or a panel width.",
        system: {
        ...
        deckLabel: "{{label}} {{w}} × {{d}} mm",
        deckingArea: "Decking",
        boardArea: "Board lining",
        sheets: "Sheets",
        insulationArea: "Insulation",
        blocks: "Blocks",
        panels: "Panels",
        stockEntry: "{{length}} mm × {{count}}",
        wasteSuffix: "waste {{pct}} %",
        splices: "{{n}} splices",
        ...
        timberClass_GL24h: "GL24h — glulam",
        kmod: "k_mod (load duration, service class)",
        gammaM: "γ_M (material factor)",
        kdef: "k_def (creep)",
        gammaG: "Partial factor, permanent load (γG)",
        gammaQ: "Partial factor, variable load (γQ)",
      ...
      checks: {
        title: "Structure",
        loadG: "Permanent load (kN/m)",
        loadQ: "Variable load (kN/m)",
        loadWall: "Wall self-weight (kN/m)",
        loadExtra: "Additional load (kN/m)",
        span: "Span",
        section: "Section",
        bending: "Bending",
        shear: "Shear",
        deflection: "Deflection",
        deflectionValue: "Deflection / limit",
        result: "Result",
        pass: "passes",
        fail: "fails",
        governing: "governing",
        missingRow: "Missing: {{row}}",
        missingWallMaterial: "the wall's material (in the wall panel)",
      ...
      frame: {
        ...
        note_postWidth: "No post width stated — no studs drawn",
        note_block: "No block format stated — no courses drawn",
        note_panel: "No panel width stated — no panels drawn",
        breaks: "Frame breaks",
        breakHeight: "Break {{n}} height (mm)",
      ...
      symbol: {
        ...
        "airco-wall": "Split unit (wall)",
        "airco-ceiling": "Ceiling cassette",
      ...
      stairUse: {
        ...
        woonfunctie: "dwelling (woonfunctie)",
        overig: "other use (non-residential)",
      },
      stairIssue: {
